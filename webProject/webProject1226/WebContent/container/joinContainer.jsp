				...
				<table>
					...
					<tr>
						...
						<td><input type="radio" name="gender" id="gender1" value="남자"
							checked>남 <input type="radio" name="gender" id="gender2"
							value="여자">여</td>
					</tr>
					<tr>
						<td><label for="hobbys">취미</label></td>
						<td><input type="checkbox" name="hobbys" id="hobbys1"
							value="게임">게임 <input type="checkbox" name="hobbys"
							id="hobbys2" value="등산">등산 <input type="checkbox"
							name="hobbys" id="hobbys3" value="요리">요리 <input
							type="checkbox" name="hobbys" id="hobbys4" value="여행">여행
					...
					<tr>
						<td id="btn" colspan="2"><input type="reset" value="초기화">
							<input type="submit" class="joinOK" value="회원가입 실행"></td>
					</tr>
				</table>
			</form>
		</div>
